...
test.describe("Scope Isolation — styles stay inside .cider", () => {
  ...
  test("table border-collapse only overridden inside .cider", async ({
    page,
  }) => {
  ...
  test("checkbox appearance only overridden inside .cider", async ({
    page,
  }) => {
...
test.describe("Scope Isolation — .cider-reset stops styles", () => {
  ...
  test("h1 inside .cider-reset does not get CiderUI h1 styles", async ({
    page,
  }) => {
  ...
  test("checkbox inside .cider-reset has browser default size", async ({
    page,
  }) => {
