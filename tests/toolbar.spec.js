...
test.describe("Toolbar", () => {
  ...
  test("toolbar renders with glass background and min-height", async ({
    page,
  }) => {
  ...
  test("toolbar-group buttons are connected with separators", async ({
    page,
  }) => {
    const buttons = preview(page)
  ...
  test("toolbar-title is visible with correct font weight", async ({
    page,
  }) => {
